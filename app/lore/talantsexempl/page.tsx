...
export default async function TalantExPage() {
    ...
    const elArr = [
        ...
        {
            name: "Перевоплощение",
            descr: "(Превращаться в носителя образа)"
        },{
        ...
        ,{
            ...
            name: "Призыватель",
            descr: "(Увелививает время действия призывов + количество и силу призываемых существ)"
        },,{
        ...
        {
            name: "Дипломатия",
            descr: "(Уменее договориться)"
        },
        {
            name: "Телепатия",
            descr: "(Общение образами)"
        },
        {
            name: "Повысить уровень хар-ки",
            descr: "(+1 к уровню хар-ки по выбору ( должно пройти проверку ДМа ))"
        },
