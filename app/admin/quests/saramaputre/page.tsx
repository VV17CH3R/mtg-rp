    ...
    <div className="flex items-center  justify-center">
      ...
      <br></br><span className="font-extrabold text-primary text-xl"> царь Джанамеджая  ltc/52 </span>
        ...
        <br></br><span className="font-extrabold text-primary text-xl">  Дэви Левия  clu/199 </span>
            ...
            <text className="w-96">
            Мотив призыва МаяСомы : 
         У Нас есть сын, н он не признал меня своей
        женой. Всех демонов знают. Ты новая в служении мироходка... ВЫ полни и я
        дарую тебе Дар, Осквернять любую воду ядом. В твоем мире любят принимать
        малые дозы яда и отправляться в состояние Призраков. Я дараю тебе Дар
        над этими веществами. Я их повелительница, я их совершенно освоила. И
        так оскверни его Жертвоприношение... Оно почти завершено и будет идти
        еще 3 дня.
        <br></br> Решение Квеста : <br></br>
         Братьев Споить... Избили собаку... Донести до Сарамы... На
        тебе клеймо неудачи .. Сарама Прокляла... Что бы ты не делал будет
        неудачно....
        <br></br>
        
         Это проклятие может снять только сын наги... Они хотят
        снять проклятие! Они закрылись в ТакшаШире... Верни мне моего сына!
        Собрать отряд, взять крепость... 7 дней будет идти обряд очищения.
        Надень это и попроси его никогда более не покидать мать ... Он не сможет
        отказать Брахману... В древности он дал обет... 
        <br></br> Осда города... <br></br>

        Мотивы: Джанамеджаи:
        "Моя Ягья провалилось, люди будут страдать без достойного царя... Нужно найти способ снять проклятие Сарамы.."<br></br>
        Решение: Шрута Шравас даст побочку... Расположение Мудреца... Мой сын может снять он славен подвигами... Но Мать Жадно стережет его. Передай ему послание, что я зову его. 
        Он в дал обет. От того он пойдет с Вами. Лишь скажите ему. 
